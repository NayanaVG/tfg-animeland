import { AfterViewInit, Component, ComponentRef, inject, Input, model, ViewChild, viewChild, ViewContainerRef } from '@angular/core';
...
export class CrearEntidadComponent<TDTO, TCreacionTDTO> implements AfterViewInit{
