...
namespace PeliculasAPI.Controllers
{
    public class CustomBaseController: ControllerBase
    {
            ...
            where TEntidad: class
        {
            ...
            return await queryable
                ...
                .ProjectTo<TDTO>(mapper.ConfigurationProvider).ToListAsync();
                 // ConfigurationProvider: realiza la proyeccion desde mi query 
        }

        protected async Task<ActionResult<TDTO>> Get<TEntidad, TDTO>(int id)
            where TEntidad : class, IId
            where TDTO : IId
            // TEntidad implementa IId, IId obliga a implementar una entidad del tipo/nombre Id 
        {
            ...
            where TEntidad: class, IId
        {
            ...
            await outputCacheStore.EvictByTagAsync(cacheTag, default); //Para limpiar el cache al crar un genero
            ...
            where TEntidad: class, IId
        {
            ...
            await context.SaveChangesAsync();
            await outputCacheStore.EvictByTagAsync(cacheTag, default); // Limpiar el cache al actualizar un genero
